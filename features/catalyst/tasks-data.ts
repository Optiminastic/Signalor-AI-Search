 ...
 * The detail page was printing these raw, so the page named things the way the
 * database does rather than the way the reader does — the single biggest reason
 * it read as an internal tool rather than a product.
 *

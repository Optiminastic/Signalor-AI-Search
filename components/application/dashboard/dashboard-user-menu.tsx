...
function UserMenuItem({
  ...
  return (
    <a
      ...
      onClick={onSelect}
      className={cx(
        'rounded-2lg flex w-full items-center gap-2 px-2 py-1.5 transition-colors outline-none',
        isSelected
    ...
    >
      ...
      <span className="text-body-medium text-text-primary truncate">{name}</span>
    </a>
  )
}
  ...
  return (
    <>
      ...
      <div className="flex w-full flex-col gap-1.5 pt-[5px]">
        <span className="text-body-medium text-text-secondary px-2">Users with access</span>
      ...
      <div className="bg-border-button-default -mx-2.5 my-3.5 h-px" />
      ...
      >
        ...
        <Collapsible collapsed={collapsed}>
          <span className="flex items-center gap-0.5">
            ...
            <ChevronUpDownSmall className="text-foreground-icon-tertiary size-4 shrink-0" />
          </span>
        </Collapsible>
      </AriaButton>

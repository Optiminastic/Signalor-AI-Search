        ...
        <SettingsRow label="Date of birth">
          <button
            ...
            className={[
              ...
              'ease hover:bg-background-primary-hover transition-colors duration-150',
              'focus-visible:ring-border-focus-ring outline-none focus-visible:ring-2',
            ].join(' ')}
          >
            <RiCalendarLine
              className="text-foreground-icon-primary size-[18px] shrink-0"
              aria-hidden
            />
            <span className="text-body-regular text-text-primary px-0.5 whitespace-nowrap">

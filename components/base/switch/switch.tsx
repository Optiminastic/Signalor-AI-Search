 ...
 *           #2473fe / #0450e2 are raw Figma fills (no token yet).
 *
...
export const switchSizes = sortCx({
  sm: {
    ...
    onShadow: 'shadow-[inset_0_1px_0_0_rgb(255_255_255/0.25),inset_0_0_0_0.5px_#c53f34]',
    thumb: 'size-3',
  ...
  md: {
    ...
    onShadow: 'shadow-[inset_0_1.5px_0_0_rgb(255_255_255/0.25),inset_0_0_0_0.75px_#c53f34]',
    thumb: 'size-[18px]',
...
export function SwitchTrack({
  ...
  return (
    <span
      aria-hidden
      className={cx(
        'ease relative shrink-0 transition-colors duration-200',
        s.track,
        s.trackRadius[shape],
        state.isSelected
          ? // Retinted from BoardUI's blue to Signalor red so the "on" state
            // matches the app's primary CTAs.
            cx('bg-linear-to-b from-[#e04a3d] to-[#c53f34]', s.onShadow)
    ...
    >
      ...
      <span
        className={cx(
          ...
          'from-control-indicator-background to-control-indicator-background-subtle bg-linear-to-b from-[43.837%]',
      ...
      >
        ...
        <span
          className={cx(
            ...
            s.chipRadius[shape],
            state.isSelected
              ? // Retinted to the Signalor red ramp (was blue #2473fe→#0450e2).
                'border-[#b9382d] from-[#e8564a] to-[#c53f34]'

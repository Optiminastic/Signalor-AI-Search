...
export function Kbd({ className, ref, ...props }: KbdProps) {
  return (
    <kbd
      ref={ref}
      className={cx(
        'bg-kbd-background text-caption-1-semibold text-kbd-foreground inline-flex items-center justify-center rounded-full px-1 py-0.5 font-sans tracking-normal whitespace-nowrap',
        className,
      )}
      {...props}
    />

...
export function Tooltip({
  ...
  return (
    <AriaTooltip
      ...
      className={state =>
        cx(
          'border-border-button-default bg-background-primary-default text-text-primary shadow-dropdown pointer-events-none z-50 max-w-[240px] rounded-lg border select-none',
          sizes[size],
          ...
          {({ placement }) => {
            ...
            return (
              <svg
                ...
                className="fill-background-primary-default stroke-border-button-default block overflow-visible"

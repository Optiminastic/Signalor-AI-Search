          ...
          item === DOTS ? (
            ...
            <li key={item}>
              <button
                ...
                className={cx(
                  cell,
                  'focus-visible:ring-border-focus-ring cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
                  item === page
                    ? 'border-border-button-default bg-background-primary-default text-text-primary border shadow-xs'
